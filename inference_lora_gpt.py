...
dataset_finetuned = "alpaca_data-structured_alpaca_1000"  # or "alpaca_data"
adapter_path = os.path.abspath(f"finetuned_models/{base_model_name}-lora-{dataset_finetuned}-final")
...
print(f"🔧 Loading LoRA adapter...{adapter_path} for base {base_model}")
...
if __name__ == "__main__":
    print("\n💬 LoRA GPT Inference Ready! Type your instruction below.\nPress Ctrl+C to exit.\n")
